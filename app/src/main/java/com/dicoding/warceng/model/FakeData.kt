...
object FakeData {
    val dummyMenu = listOf(
        Menu(1, R.drawable.menu_1, "Drink", "Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id es", "Coffee Mantan", 5),
        ...
        Menu(9, R.drawable.menu_9, "Dessert", "Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id es", "Sosis Yang Bikin Kangen", 7),
        Menu(10, R.drawable.menu_10, "Drink", "Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id es", "Coffee Vanilla Kesukaan Kamu", 6),
        Menu(11, R.drawable.menu_11, "Drink", "Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id es", "Choko Shake Hati Dia", 9),
        Menu(12, R.drawable.menu_12, "Drink", "Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id es", "Coffee Cappucino Senyuman Mantan", 10),
        Menu(13, R.drawable.menu_13, "Drink", "Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id es", "Vanilla Latte Campuran Rasa Cinta Dan Kasih Dia", 10),
    )
}